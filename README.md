...
> <img width="1852" height="974" alt="image" src="https://github.com/user-attachments/assets/003a6a57-c400-4c97-ac00-0ba1dc0425aa" />
...
- **放行 `/api/plugins/beszel/security/ingest`** → 反代 hermes `127.0.0.1:9119`（collector 用 Bearer token 认证）
- 两条放行都 fail-closed：无效 token → 401，不是裸奔
